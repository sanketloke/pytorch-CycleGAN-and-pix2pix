...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', required=True, default='datasets/gtacityscapes', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        self.parser.add_argument('--batchSize', type=int, default=1, help='input batch size')
        self.parser.add_argument('--loadSize', type=int, default=1024, help='scale images to this size')
        self.parser.add_argument('--fineSize', type=int, default=800, help='then crop to this size')
        self.parser.add_argument('--domain_A', type=str, default='cityscapes', help='scale images to this size')
        self.parser.add_argument('--domain_B', type=str, default='gtav', help='then crop to this size')
